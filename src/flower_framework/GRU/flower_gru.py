...
# 23 is number of hours of past observations
train_x.shape
...
#model = ShallowRegressionLSTM(input_size=train_x.shape[1], hidden_units=num_hidden_units)
...
def client_fn(cid: str) -> FlowerClient:
    ...
    net = GRU(input_size=input_size, hidden_units=num_hidden_units).to(DEVICE)
...
params = get_parameters(GRU(input_size=train_x.shape[1], hidden_units=16))
